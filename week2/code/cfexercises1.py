...
def foo_2(x, y):
    """ foo_2 will return the larger number between x and y"""
    if x > y:
...
def foo_3(x, y, z):
    """ The functions swaps the values of x and y around if x is greater than y, 
...
def main(argv):
    """" Main entry point of the program: testing the functions"""
    print(foo_1(16))
    print(foo_2(2, 3))
    print(foo_2(3, 2))
    print(foo_3(4, 3, 5)
